...
st.set_page_config(
    page_title="Doctor Appointment — Swasthya Setu",
    page_icon="🏥",
    layout="wide"
)

# ── Shared sidebar / theme / language ──
...
# Inject language as a JS variable before </head>
lang_script = f'<script>window.SWASTHYA_LANG = "{lang}";</script>'
html_content = html_content.replace('</head>', lang_script + '</head>')
