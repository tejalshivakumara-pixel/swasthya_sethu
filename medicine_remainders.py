...
st.set_page_config(page_title="Medicine Reminders — Swasthya Setu", page_icon="💊", layout="wide")
...
html_path = os.path.join(os.path.dirname(__file__), '..', 'medicine_remainders.html')
